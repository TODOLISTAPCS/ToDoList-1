...
public class ToDoItemTest {
  ...
  public void testToDoItem1() {
    ToDoItem item = new ToDoItem(-1, "Test description","Mon 01/01");
  ...
  public void testToDoItem2() {
    ToDoItem item = new ToDoItem(-1, "Test description 2", "Mon 01/01", true);
  ...
  public void testGetId() {
    ToDoItem item = new ToDoItem(22, "Test description","Mon 01/01");
  ...
  public void testGetDescription() {
    ToDoItem item = new ToDoItem(2, "Test description", "Mon 01/01");
    assertEquals("getDescription", "Test description", item.getDescription());
  }
  ...
  public void testToggleDone() {
    ToDoItem item = new ToDoItem(2, "Test description","Mon 01/01", true);
    item.toggleDone();
    assertFalse("setDone set done to false", item.isDone());
    item.toggleDone();
    assertTrue("setDone set done to true", item.isDone());
